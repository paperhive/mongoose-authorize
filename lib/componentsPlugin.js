...
module.exports = function (config) {
  return function (schema, options) {
    ...
    schema.methods[config.authorizedSet] = 
      function (userId, obj, done) {
        authorizedSet(this, userId, obj, done);
      };
    function authorizedSet(doc, userId, obj, done) {
      ...
      return async.waterfall([
        ...
        function (writeComponents, cb) {
          ...
          return checkObjectSchema(obj, doc.schema, doc, writeComponents, cb);
        },
        function (cb) {
          ...
          function (writeComponents, cb) {
            ...
            return componentResolve(
              ...
              function (err, component) {
                ...
                return checkObjectSchema(json, array._schema.schema, null, 
                                       writeComponents, cb);
              }
            );
          },

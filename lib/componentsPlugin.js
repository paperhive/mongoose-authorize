...
module.exports = function (config) {
  return function (schema, options) {
     ...
     */
    schema.methods[config.authorizedSetFromJSON] = 
      function (json, userId, done) {
        authorizedSetFromJSON(json, this, userId, done);
      };
    function authorizedSetFromJSON(json, doc, userId, done) {
    ...
    schema.methods[config.authorizedArrayPushJSON] =

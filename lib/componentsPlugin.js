...
module.exports = function (config) {
  return function (schema, options) {
    ...
    function authorizedSetFromJSON(json, doc, userId, done) {
      ...
      return async.waterfall([
        ...
        function (writeComponents, cb) {
          ...
          return checkJSONToDoc(json, doc, writeComponents, cb);
        },
        function (cb) {
    ...
    // recursively walks the json object and the doc schema
    function checkJSONToDoc(json, doc, writeComponents, done) {
              ...
              if (pathConfig) {
                ...
                if (_.isArray(pathConfig.options.type)) {
                  ...
                  if (pathConfig.options.type[0].paths) {
                    return cb(new Error('subdocuments not allowed in arrays'));
                  }
